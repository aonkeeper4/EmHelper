...
local Monumentswitchblock = {}

local frames = {
    "objects/monumentswitchblock/solid0",
    "objects/monumentswitchblock/solid1",
    "objects/monumentswitchblock/solid2",
    "objects/monumentswitchblock/solid3"
}

Monumentswitchblock.name = "EmHelper/Monumentswitchblock"
Monumentswitchblock.minimumSize = {16, 16}
Monumentswitchblock.fieldInformation = {
    index = {
        fieldType = "integer",
    }
}
...
Monumentswitchblock.placements = {
    name = "Monument Switchblock [EmHelper]",
    data = {
        width = 16,
        height = 16,
        pattern = 0,
...
local function getSearchPredicate(entity)
    return function(target)
        return entity._name == target._name and entity.pattern == target.pattern and entity.color == target.color
    end
end
...
function Monumentswitchblock.sprite(room, entity)
    ...
    local index = entity.pattern or 0
